  ...
  return (
    <>
      ...
      <div style={{textAlign: "center", width: "50%", margin: "0 auto"}}>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse ipsum elit, posuere ut augue ut, gravida tincidunt neque. Quisque vestibulum dolor nec ligula maximus maximus. Maecenas porta semper lacus vitae faucibus. In hac habitasse platea dictumst. Etiam neque ante, ornare at commodo quis, placerat sed metus. Morbi laoreet urna a odio hendrerit, vel sollicitudin mi blandit. </p>
        <h2>the original</h2>
        ...
        <p>Nunc dignissim vel urna quis eleifend. Cras ut arcu ut arcu lacinia tempus. Aliquam semper massa felis, eu tincidunt risus elementum ut. Nam nec tortor augue.</p>
        <div style={{display: "flex"}}>
          <div>
